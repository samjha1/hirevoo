                            ...
                            <div class="auth-content card-body p-5 text-white">
                                <div class="w-100">
                                    ...
                                    <div class="d-grid gap-2 mb-3">
                                        <a href="{{ route('auth.google.redirect') }}?role={{ $roleVal }}&from=register{{ request()->has('redirect') ? '&redirect=' . urlencode(request('redirect')) : '' }}" class="btn btn-light btn-hover d-flex align-items-center justify-content-center gap-2">
                                        ...
                                        <a href="{{ route('auth.microsoft.redirect') }}?role={{ $roleVal }}&from=register{{ request()->has('redirect') ? '&redirect=' . urlencode(request('redirect')) : '' }}" class="btn btn-light btn-hover d-flex align-items-center justify-content-center gap-2">
